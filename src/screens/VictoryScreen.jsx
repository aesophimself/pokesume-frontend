...
const VictoryScreen = () => {
  ...
  if (!completedCareerData) {
    return (
      <div className="w-full h-screen bg-gradient-to-b from-yellow-400 to-orange-500 flex items-center justify-center p-2 sm:p-4">
        <div className="bg-white rounded-lg p-6 sm:p-8 max-w-2xl w-full shadow-2xl text-center">
          ...
          <h1 className="text-3xl sm:text-4xl font-bold mb-4 text-gray-800">CHAMPION!</h1>
          <p className="text-gray-600 mb-6">Loading results...</p>
          <button
            onClick={() => {
              setGameState('menu');
  ...
  return (
    <div className="w-full h-screen bg-gradient-to-b from-yellow-400 to-orange-500 flex items-center justify-center p-2 sm:p-4 overflow-y-auto">
      <div className="bg-white rounded-lg p-6 sm:p-8 max-w-2xl w-full shadow-2xl my-4">
        ...
        <p className="text-gray-600 mb-1 text-center">You defeated all gym leaders and the Elite Four!</p>
